...
async def build_settings_view(page, am, app_state, navigate_to, show_snack):
    ...
    for i, acc in enumerate(am.accounts):
        ...
        account_list.controls.append(
            ft.Card(
                content=ft.ListTile(
                    leading=ft.Icon(ft.Icons.ACCOUNT_CIRCLE, size=30, color=ft.Colors.BLUE_700),
    ...
    return ft.View(
        ...
        [
            ...
            ft.ListView(expand=True, padding=10, controls=[account_list, ft.Container(height=80)]),
